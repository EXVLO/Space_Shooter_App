...
from Shared_Resources import (
    ...
    BUTTON_COLOR, BUTTON_HOVER_COLOR, font, small_font,
    TEXT_COLOR, draw_text,
    BUTTON_COLOR_RED, BUTTON_HOVER_COLOR_RED
)
...
def show_friend_window():
    screen.fill(BACKGROUND_COLOR)
    pygame.display.set_caption("Friends List")
    ...
    draw_text(screen, "Friends List", font, TEXT_COLOR, SCREEN_WIDTH // 2, 40, align="center")
    ...
    def render_friends():
        ...
        for i, friend in enumerate(curr_Client.friends):
            ...
            draw_text(screen, friend, small_font, TEXT_COLOR, friend_card.x + 10, friend_card.centery, align="midleft")
            ...
            draw_text(screen, "Remove", small_font, TEXT_COLOR, remove_button.centerx, remove_button.centery, align="center")
    ...
    while True:
        ...
        draw_text(screen, "Add Friend", small_font, TEXT_COLOR, add_button.centerx, add_button.centery, align="center")

        # Draw the input box and "Add Friend" button
        pygame.draw.rect(screen, color1, input_box, border_radius=8)
        draw_text(screen, input_text, small_font, TEXT_COLOR, input_box.x + 10, input_box.centery, align="midleft")
                ...
                for button, index in buttons:
                    if button.collidepoint(event.pos):
                        if index == -1:
                            ...
                            del curr_Client.friends[index]  # Remove the friend from the list
